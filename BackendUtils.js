...
class UserModel {
  ...
  const username = 'StumblePit ' + CryptoUtils.GenCaracters(10).toUpperCase();
  ...
  static tournaments = [
    {
      ...
      nameKey: "Pit BDL 1v1 Duels",
      descriptionKey: "(.gg/sgpit) - Compete in free-for-all matches, be the last one standing to win!",
...
colourData: {
  ...
  infoWidgetsBorderColour: "#6FD0FF"
    ...
    },
    {
      ...
      startTime: new Date(),
      endTime: new Date(Date.now() + 5 * 365 * 24 * 60 * 60 * 1000),
      nameKey: "Pit BD 1v1 Duels",
      descriptionKey: "(.gg/sgpit) - Fast 1v1 duels. Pure skill. Only victory.",
...
colourData: {
  ...
  infoWidgetsBorderColour: "#328bffff"
    ...
    },
    {
      ...
      startTime: new Date(),
      endTime: new Date(Date.now() + 5 * 365 * 24 * 60 * 60 * 1000),
      nameKey: "Pit RH 1v1 Duels",
      descriptionKey: "(.gg/sgpit) - Win, Farps and be the best",
    ...
    try {
      ...
      if (tournament.entryCurrencyCost > 0) {
        ...
        if (userBalance < tournament.entryCurrencyCost) {
          Console.log("PitArena", `Insufficient balance for user ${user.username} to join tournament ${tournamentId}`);
